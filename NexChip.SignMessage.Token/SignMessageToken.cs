...
namespace NexChip.SignMessage.Token
{
    ...
    /// 令牌类
    /// </summary>
    public class SignMessageToken
    {

        public SignMessageToken()
        {
        }
        ...
        public static string IssueJWT(TokenModel tokenModel, TimeSpan expiresSliding, TimeSpan expiresAbsoulte)
        {
            ...
            issuer: "NexChip.SignMessage",//jwt签发者,非必须
            ...
            signingCredentials: new Microsoft.IdentityModel.Tokens
                .SigningCredentials(new SymmetricSecurityKey(Encoding.ASCII.GetBytes("NexChipSignMessage")), SecurityAlgorithms.HmacSha256));//使用私钥进行签名加密
